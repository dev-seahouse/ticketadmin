        ...
        <div class="col-md-7 col-md-offset-2">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="well">
                        <p>
                            Installation may make take several minutes to complete. Once you click '<b>Install Ticket Admin</b>' the config settings will be written to this file: <b>{{base_path('.env')}}</b>. You can manually change these settings in the future by editing this file.
                        </p>
                        <p>
                        ...
                        <p>
                            If you are using shared hosting please ask your host if they support the Ticket Admin requirements before requesting support.
                        </p>
                    </div>

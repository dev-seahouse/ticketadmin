...
<meta name="apple-mobile-web-app-title" content="TicketAdmin">
...
<meta name="application-name" content="TicketAdmin">
<meta name="_token" content="{{ csrf_token() }}" /> {{--Mobile browser theme colors--}}

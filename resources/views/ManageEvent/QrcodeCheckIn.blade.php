...
<head>
  <title>
      TicketAdmin QRCode Check In: {{ $event->title }}
  </title>
...
<body>
  <div id="main">
    <header id="header">
      <h2 class="text-center"><img style="width: 40px;" class="logo" alt="TicketAdmin" src="{{ asset('/assets/images/logo-dark.png') }}"/><br><span style="font-size: 0.7em;">Check In: <strong>{{ $event->title }}</strong></span></h2>
    </header>

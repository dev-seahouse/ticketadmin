                            ...
                            <div class="tab-pane " id="about">
                                ...
                                <p>
                                    @if($version_info['is_outdated'])
                                        Your version (<b>{{ $version_info['installed'] }}</b>) of TicketAdmin is out of date. The latest version (<b>{{ $version_info['latest'] }}</b>) can be <a href="https://TicketAdmin.com/documentation.php#download" target="_blank">downloaded here</a>.
                                    @else
                                        Your TicketAdmin version (<b>{{ $version_info['installed'] }}</b>) is up to date!
                                    @endif
                                </p>

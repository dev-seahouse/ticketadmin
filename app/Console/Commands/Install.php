...
class Install extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install Ticket Admin';
    ...
    public function handle()
    {
        ...
        $this->comment('--------------------');
        $this->comment('Attempting to install Ticket Admin v' . $version);
        $this->comment('--------------------');
    ...
    _______ _      _        _               _           _
 |__   __(_)    | |      | |     /\      | |         (_)
    | |   _  ___| | _____| |_   /  \   __| |_ __ ___  _ _ __
    | |  | |/ __| |/ / _ \ __| / /\ \ / _` | '_ ` _ \| | '_ \
    | |  | | (__|   <  __/ |_ / ____ \ (_| | | | | | | | | | |
    |_|  |_|\___|_|\_\___|\__/_/    \_\__,_|_| |_| |_|_|_| |_|

        ");

        $this->comment('Success! You can now start selling your tickets');
    }
}
